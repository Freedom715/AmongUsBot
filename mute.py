...
async def invite(ctx):
    await ctx.send("Invite Link: <https://discord.com/oauth2/authorize?client_id=693361472683769887&scope=bot"
                   "&permissions=4271168>")
...
# run the bot
client.run("NjkzMzYxNDcyNjgzNzY5ODg3.Xn79MQ.n9D9irT-tBK7e0Kkrb9dLqbl2mU")